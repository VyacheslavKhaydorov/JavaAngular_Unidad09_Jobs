...
public class Empleado {
	...
	public Empleado(int ID, String nombre, double sueldo, String categoria) {
		...
		//Llamada al m�todo de control de categoria
		this.categoria = categoriaCorrecta(this.categoria);
		
		//Llamada al m�todo de ajuste de sueldo
	...
	//M�todo para ajustar el sueldo seg�n la categoria
	...
	//M�todo de control sobre el rango de sueldos
	public boolean controlRangoSueldo (double sueldo, String categoria) {
		...
		//hay que añadir un else sueldo correcto a false en senior mid y junior	
